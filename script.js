...
// The game starts with this button for 'Challenge Friend'
let gameStart = document.getElementById("start2a");
...
// The result generating starts with clicking the 'See Result' button
let seeResult1 = document.getElementById("start2b");
...
seeResult1.addEventListener("click", function() {
    ...
    // Get the user's first name
    let firstName1 = document.getElementById("first-name2").value;

    // Get the user's team choice
    let prediction1 = document.getElementById("prediction2").value;
    console.log(prediction1);
    ...
    if(prediction2 === result2) {
        // Get amount and convert to number
        let gameAmount2 = document.getElementById("amount1").value;
        gameAmount2Slice = gameAmount1.slice(1);
        gameAmount2Number = parseInt(gameAmount2Slice);
        // Get the match
        let match1 = localStorage.getItem("match2");
        // Update HTML in modal
